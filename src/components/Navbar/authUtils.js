...
export const resetInactivityTimer = (
  ...
  const resetTimer = () => {
   ...
   // warningTimeout = setTimeout(showWarning, 300000); // Mostrar advertencia tras 10 segundos
   // inactivityTimeout = setTimeout(handleInactivity, 400000); // Cerrar sesión tras 40 segundos para prevenir auto Login
  };
